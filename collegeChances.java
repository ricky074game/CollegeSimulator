    ...
    public static double chances(int college, double GPA, int SAT, int ACT, double extracurriculars, double essayStrength, double interview) {
        ...
        if (college >= 1 && college <= 4) { // tier 1
            ...
            if (tier == 1) {
                ...
                return (16 + (Math.random() * 4 - 2));
            }
            else if (tier == 8) {
                return (8 + (Math.random() * 2 - 1));
            }
            else if (tier == 9) {
            ...
            if (tier == 1) {
                ...
                return (72 + (Math.random() * 8 - 4));
            }
            else if (tier == 3) {
                return (64 + (Math.random() * 8 - 4));
            }
            else if (tier == 4) {
                return (58 + (Math.random() * 8 - 4));
            }
            else if (tier == 5) {
                return (45 + (Math.random() * 8 - 4));
            }
            else if (tier == 6) {
                return (34 + (Math.random() * 8 - 4));
            }
            else if (tier == 7) {
            ...
            if (tier == 1) {
                ...
                return (84 + (Math.random() * 8 - 4));
            }
            else if (tier == 3) {
                return (73 + (Math.random() * 8 - 4));
            }
            else if (tier == 4) {
                return (65 + (Math.random() * 8 - 4));
            }
